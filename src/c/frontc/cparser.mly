%{
    (* C Parser, modified by Stefan Muller 2022 to parse Mini-C syntax *)
...
(*  | typedef SEMICOLON {$1} *)
  | STRUCT type_name LBRACE field_list RBRACE SEMICOLON
    {Clexer.add_type $2; STRUCTDEF ($2, $4)}
;
global_type:
...
field_mod_list_opt field_qual
  ...
  | field_mod_list_opt enum_type field_mod_list_opt
    {apply_mods $3 (apply_mods $1 ($2, NO_STORAGE))}
  | field_mod_list_opt type_name field_mod_list_opt
    {apply_mods $3 (apply_mods $1 (NAMED_TYPE $2, NO_STORAGE))}
;
field_mod_list_opt:
/* empty */      {[]}
...
statement:
  ...
  | FOR LPAREN local_type local_defs SEMICOLON opt_expression
    SEMICOLON opt_expression RPAREN statement
     {set_line $1 (SEQUENCE(DEFINITION
                              (DECDEF (set_name_group $3 (List.rev $4))),
                            FOR (NOTHING, $6, $8, $10)))}
